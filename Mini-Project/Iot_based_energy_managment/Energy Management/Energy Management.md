...
#Tasks
- [ ] [Turn the fan off when no one is using](#turn%20the%20%20fan%20off%20when%20no%20one%20is%20using)
- [ ]  [Dim the light according to the light intensity from the surrounding](#dim%20the%20light%20according%20to%20the%surrounding)
- [ ] 
